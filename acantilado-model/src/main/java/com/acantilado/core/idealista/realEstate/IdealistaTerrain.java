...
public class IdealistaTerrain extends IdealistaRealEstate<IdealistaTerrainPriceRecord> {
  @Id
  ...
  public static IdealistaTerrain constructFromJson(JsonNode jsonNode) {
    ...
    IdealistaTerrain terrain =
        new IdealistaTerrain(
            base.propertyCode(),
            base.operation(),
            base.description(),
            base.size(),
    ...
    IdealistaTerrainPriceRecord priceRecord =
        new IdealistaTerrainPriceRecord(base.propertyCode(), base.price(), base.firstSeen());
  ...
  public List<IdealistaTerrainPriceRecord> getPriceRecords() {
    return priceRecords;
  }

  public void setPriceRecords(List<IdealistaTerrainPriceRecord> priceRecords) {
