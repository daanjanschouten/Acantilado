...
@NamedQueries({
  @NamedQuery(
      ...
      query =
          "SELECT p FROM IdealistaTerrainPriceRecord p WHERE p.propertyCode = :propertyCode ORDER BY p.recordedAt DESC"),
  @NamedQuery(
      name =
...
public class IdealistaTerrainPriceRecord extends IdealistaPriceRecordBase {
  ...
  public IdealistaTerrain getTerrain() {
    return terrain;
  }

  public void setTerrain(IdealistaTerrain terrain) {
