...
@NamedQueries(
        {
                @NamedQuery(
                        name = "com.schouten.core.properties.idealista.IdealistaAyuntamientoLocation.findByProvinciaId",
                ...
                @NamedQuery(
                        ...
                        query = "SELECT p FROM IdealistaAyuntamientoLocation p WHERE p.ayuntamientoLocationId = :ayuntamientoLocationId"
                )
        }
)
