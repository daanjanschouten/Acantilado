...
@JsonIdentityInfo(
    ...
    property = "ayuntamientoId")
@NamedQueries({
  @NamedQuery(name = "com.acantilado.ayuntamiento.findAll", query = "SELECT a FROM Ayuntamiento a"),
  @NamedQuery(
...
public class Ayuntamiento {
  ...
  @JsonIgnore @Transient private Geometry geometry;
    ...
    if (geometryJson != null && !geometryJson.isEmpty()) {
      try {
        ...
        throw new RuntimeException(
            "Failed to parse geometry for ayuntamiento: " + ayuntamientoId, e);
      }
    }
  }
