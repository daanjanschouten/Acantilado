...
public class GoogleAmenitySnapshot {
    ...
    public GoogleAmenityStatus getStatus() { return status; }
    public OpeningHours getOpeningHours() { return openingHours; }
    public Optional<Double> getRating() { return Optional.ofNullable(rating); }
    public Optional<Integer> getUserRatingCount() { return Optional.ofNullable(userRatingCount); }
    ...
    public void setStatus(GoogleAmenityStatus status) { this.status = status; }
    ...
    public GoogleAmenitySnapshot withUpdatedMetadata(Integer newUserRatingCount, Instant newLastSeen) {
