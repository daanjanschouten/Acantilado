...
class OpeningHourTest {
  ...
  public void throwsForBadHours() {
    Assertions.assertThrows(IllegalArgumentException.class, () -> new OpeningHour(24, 1, 5, 40));
  }

  @Test
  public void throwsForBadMinutes() {
    Assertions.assertThrows(IllegalArgumentException.class, () -> new OpeningHour(3, 70, 5, 40));
  }
