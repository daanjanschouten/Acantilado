...
public class IdealistaRealEstateResource {
  ...
  public IdealistaRealEstateResource(
  ...
  @UnitOfWork
  public List<IdealistaProperty> getPropertiesByMunicipality(
  ...
  public IdealistaPropertyPriceRecord getLatestPropertyPrice(@PathParam("code") Long code) {
    findPropertySafely(code);
    return propertyPriceRecordDAO
        .findLatestByPropertyCode(code)
  ...
  @Path("/properties/{code}")
  @UnitOfWork
  public IdealistaProperty updateProperty(
      @PathParam("code") Long code, IdealistaProperty property) {
    findPropertySafely(code);
  ...
  @UnitOfWork
  public List<IdealistaTerrain> getTerrainsByMunicipality(
      @PathParam("municipality") String municipality) {
