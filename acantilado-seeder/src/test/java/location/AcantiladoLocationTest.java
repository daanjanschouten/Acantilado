...
class AcantiladoLocationTest {
  @Mock private AyuntamientoDAO ayuntamientoDAO;

  @Mock private CodigoPostalDAO codigoPostalDAO;

  @Mock private BarrioDAO barrioDAO;

  @Mock Geometry geometry;

  private final Ayuntamiento ayuntamiento =
      new Ayuntamiento("100", "someAyuntamiento", "12", "3", geometry);
  private final CodigoPostal codigoPostal =
      new CodigoPostal("someCodigoIne", "someCodigoPostal", geometry);
  ...
  //        location = AcantiladoLocation.fromLocationIdentifier("100-someCodigoIne-1111",
  // ayuntamientoDAO, codigoPostalDAO, barrioDAO);
  //
  //        Assertions.assertEquals("100-someCodigoIne-1111", location.getIdentifier());
  //    }
  //
  ...
  //                        "notANumber-someCodigoPostal-1111", ayuntamientoDAO, codigoPostalDAO,
  // barrioDAO)
  //        );
  //    }
  //
