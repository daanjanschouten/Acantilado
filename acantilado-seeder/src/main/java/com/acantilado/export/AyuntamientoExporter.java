        ...
        RetryableBatchedExecutor.executeRunnableInSessionWithTransaction(sessionFactory, () -> {
            try {
                ...
                if (ayuntamientos.isEmpty()) {
                    throw new IllegalArgumentException("No ayuntamientos found for province ID: " + provinceId);
                }
                ...
                try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile))) {
                    ...
                    for (Ayuntamiento ayuntamiento : ayuntamientos) {
                        ...
                        try {
                            ...
                            LOGGER.error("Failed to parse geometry for ayuntamiento {}", ayuntamiento.getId(), e);
                            continue;
                        }
