...
public final class ApifyRunningSearch<T> {
  ...
  public ApifyRunningSearch(
      T request, ApifySearchStatus pendingSearchStatus, String runId, String datasetId) {
  ...
  public ApifyRunningSearch<T> withStatus(ApifySearchStatus searchStatus) {
    return new ApifyRunningSearch<>(this.request, searchStatus, this.runId, this.datasetId);
  }
  ...
  public ApifySearchStatus getStatus() {
