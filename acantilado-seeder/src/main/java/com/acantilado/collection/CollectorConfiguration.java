...
public class CollectorConfiguration {
  ...
  @Valid @NotNull private AmenityCollectorConfig amenityCollector = new AmenityCollectorConfig();

  @Valid @NotNull
  private AdministrativeCollectorConfig administrativeCollector =
      new AdministrativeCollectorConfig();
