...
public class GeographicCollectorService extends CollectorService {
  ...
  public GeographicCollectorService(
      CodigoPostalDAO codigoPostalDAO,
      AyuntamientoDAO ayuntamientoDAO,
      ProvinciaDAO provinciaDAO,
      BarrioDAO barrioDAO,
      SessionFactory sessionFactory) {
    this.codigoPostalCollectorService =
        new CodigoPostalCollectorService(codigoPostalDAO, sessionFactory);
    this.administrativeCollectorService =
        new AdministrativeCollectorService(provinciaDAO, ayuntamientoDAO, sessionFactory);
    ...
    this.codigoPostalToAyuntamientoLinkingService =
        new CodigoPostalToAyuntamientoLinkingService(
            ayuntamientoDAO, codigoPostalDAO, sessionFactory);
  }
  ...
  public boolean isSeedingNecessary() {
    ...
    boolean forCodigoPostalAyuntamientoLinks =
        codigoPostalToAyuntamientoLinkingService.isSeedingNecessary();
