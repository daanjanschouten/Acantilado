...
public class BarrioCollectorService extends CollectorService {
  ...
  private static final List<CityBarrioConfig> CITY_CONFIGS =
      List.of(
          new CityBarrioConfig(
              CityAyuntamientoCode.MADRID, "/barrios/madrid_barrios.geojson", "NOMBRE"),
          new CityBarrioConfig(
              CityAyuntamientoCode.BARCELONA, "/barrios/barcelona_barrios.geojson", "NOM"),
          new CityBarrioConfig(
              CityAyuntamientoCode.VALENCIA, "/barrios/valencia_barrios.geojson", "nombre"),
          new CityBarrioConfig(
              CityAyuntamientoCode.ZARAGOZA, "/barrios/zaragoza_barrios.geojson", "nombre"),
          new CityBarrioConfig(
              CityAyuntamientoCode.SEVILLA, "/barrios/sevilla_barrios.geojson", "BARRIO"),
          new CityBarrioConfig(
              CityAyuntamientoCode.MALAGA, "/barrios/malaga_barrios.geojson", "NOMBARRIO"),
          new CityBarrioConfig(
              CityAyuntamientoCode.SAN_SEBASTIAN,
              "/barrios/sansebastian_barrios.geojson",
              "NOM_EUS"),
          new CityBarrioConfig(
              CityAyuntamientoCode.ALICANTE, "/barrios/alicante_barrios.geojson", "barrio"),
          // new CityBarrioConfig(CityAyuntamientoCode.TENERIFE,
          // "/barrios/tenerife_barrios.geojson", "BARRIO"),
          new CityBarrioConfig(
              CityAyuntamientoCode.LORCA, "/barrios/lorca_barrios.geojson", "NNCLEC"));

  public record CityBarrioConfig(
      CityAyuntamientoCode ayuntamientoCode, String geoJsonPath, String barrioTitle) {}
  ...
  public void seed() {
    ...
    try {
      ...
      transaction.commit();
      LOGGER.info(
          "Successfully seeded {} total barrios across {} cities",
          totalBarriosSeeded,
          CITY_CONFIGS.size());
    } catch (Exception e) {
