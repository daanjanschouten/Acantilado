...
/**
 * Abstract collector for Spanish administrative units from local GeoJSON files. Handles reading
 * GeoJSON FeatureCollections and constructing entity objects. Persistence is delegated to a
...
public abstract class AdministrativeUnitCollector<T> {
  ...
  private static final String INPUT_DIRECTORY =
      "./acantilado-seeder/src/main/resources/administrative/";
