...
public class ProvinciaCollector extends AdministrativeUnitCollector<Provincia> {
  ...
  private static Provincia getProvincia(String geoJsonString, NatCode natCode, String provinciaName)
    ...
    Provincia provincia =
        new Provincia(
            natCode.getProvinciaId(), provinciaName, natCode.getComunidadAutonomaId(), geom);
